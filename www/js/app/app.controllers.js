angular.module('your_app_name.app.controllers', ['ngOpenFB','ngCordova', 'ion-floating-menu', 'ionic'])


.controller('AppCtrl', function($scope, AuthService, PostService, $state, $ionicModal, $timeout, ngFB, $cordovaCamera, $ionicLoading) {
...
.controller('FeedCtrl', function($scope, PostService, $state, $ionicModal, $timeout, ngFB, $cordovaCamera, $ionicLoading) {
...
.controller('ShopCtrl', function($scope, ShopService, PostService, $cordovaSocialSharing, $cordovaCamera, $ionicLoading, $rootScope, ngFB) {
